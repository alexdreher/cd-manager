...
describe ArtistsController do
  ...
  describe "GET edit" do
    it "assigns the requested artist as @artist" do
      @mock_user.artists.stub(:find).with("37") { mock_artist }
      get :edit, :id => "37"
      assigns(:artist).should be(mock_artist)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "assigns a newly created artist as @artist" do
        @mock_user.artists.stub(:new).with({'these' => 'params'}) { mock_artist(:save => true) }
        post :create, :artist => {'these' => 'params'}
        assigns(:artist).should be(mock_artist)
      end

      it "redirects to the created artist" do
        @mock_user.artists.stub(:new) { mock_artist(:save => true) }
        post :create, :artist => {}
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved artist as @artist" do
        @mock_user.artists.stub(:new).with({'these' => 'params'}) { mock_artist(:save => false) }
        post :create, :artist => {'these' => 'params'}
        assigns(:artist).should be(mock_artist)
      end

      it "re-renders the 'new' template" do
        @mock_user.artists.stub(:new) { mock_artist(:save => false) }
        post :create, :artist => {}
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "assigns the requested artist as @artist" do
        @mock_user.artists.stub(:find) { mock_artist(:update_attributes => true) }
        put :update, :id => "1"
        assigns(:artist).should be(mock_artist)
      end
    ...
    describe "with invalid params" do
      it "assigns the artist as @artist" do
        @mock_user.artists.stub(:find) { mock_artist(:update_attributes => false) }
        put :update, :id => "1"
        assigns(:artist).should be(mock_artist)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the artists list" do
      @mock_user.artists.stub(:find) { mock_artist }
      delete :destroy, :id => "1"
